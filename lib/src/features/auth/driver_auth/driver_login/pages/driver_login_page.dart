...
class DriverLoginPage extends StatefulWidget {
  ...
  @override
  State<DriverLoginPage> createState() => _LoginPageState();
}

class _LoginPageState extends State<DriverLoginPage> {
            ...
            child: Column(
              ...
              children: [
                ...
                Align(
                    ...
                    child: InkWell(
                        onTap: () {
                          context.pushNamed(AppRoute.driverForgetPasswordPage);
                        },
                    ...
                    onPressed: () {
                      if (_key.currentState?.validate() ?? false) {
                        MyAppRouter.clearAndNavigate(
                            context, AppRoute.driverHomePage);
                      }
                    },
                    text: 'Login'),
                const SizedBox(height: 20),
                Center(
                    child: Text('- or driver_login with -',
                        style: textTheme(context)
                            .labelMedium!
                      ...
                      children: [
                        ...
                        TextSpan(
                          ...
                          recognizer: TapGestureRecognizer()
                            ..onTap = () {
                              context.pushNamed(AppRoute.driverSignupPage);
                            },
                        ),
                      ],
                    ),

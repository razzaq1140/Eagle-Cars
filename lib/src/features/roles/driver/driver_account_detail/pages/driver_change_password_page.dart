...
class DriverChangePasswordPage extends StatefulWidget {
  ...
  @override
  State<DriverChangePasswordPage> createState() => _AccountDetailPageState();
}

class _AccountDetailPageState extends State<DriverChangePasswordPage> {
              ...
              CustomElevatedButton(
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      showSnackbar(message: 'Your password has been changed',);

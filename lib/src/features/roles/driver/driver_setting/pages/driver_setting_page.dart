...
import '../../../customer/customer_setting/model/setting_model.dart';

class DriverSettingPage extends StatelessWidget {
  DriverSettingPage({super.key});

  final List<SettingModel> settingModel = [
    SettingModel(
      navRoute: AppRoute.driverAccountDetailPage,
    ...
    SettingModel(
      navRoute: AppRoute.driverSupportPage,
      type: "Help & Support",

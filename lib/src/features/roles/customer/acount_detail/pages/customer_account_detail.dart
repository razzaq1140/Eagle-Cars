...
class CustomerAccountDetailPage extends StatefulWidget {
  const CustomerAccountDetailPage({super.key});

  @override
  State<CustomerAccountDetailPage> createState() =>
      _CustomerAccountDetailPageState();
}

class _CustomerAccountDetailPageState extends State<CustomerAccountDetailPage> {
